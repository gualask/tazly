...
Tool-native, calmo, preciso. Tre parole: **affilato, sobrio, immediato**. Il tono è quello di un buon strumento da sviluppatore — Linear, Raycast, k9s — dove la tipografia è tight, la densità informativa alta, il colore funzionale (mai decorativo), le micro-interazioni discrete. Voce UX: imperativa breve ("Aggiungi tag", "Categoria richiesta"), niente esclamativi, niente entusiasmo finto, niente emoji decorative.
...
- **SaaS-cream generico**: gradient blu, hero metric gigante, glassmorphism decorativo, card grid uniforme. Vietate in modo assoluto.
